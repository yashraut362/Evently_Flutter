...
class Washrooms extends StatefulWidget {
  @override
  _WashroomsState createState() => _WashroomsState();
}

class _WashroomsState extends State<Washrooms> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("Information about Washrooms")),
      ),
      body: showDrivers(),
    );
  }
  ...
  getDriversList() async {
    return await Firestore.instance
        .collection('places')
        .where('Category', isEqualTo: 'Washrooms')
        .getDocuments();
  }
}
