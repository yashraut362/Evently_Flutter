...
class Teastalls extends StatefulWidget {
  @override
  _TeastallsState createState() => _TeastallsState();
}

class _TeastallsState extends State<Teastalls> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("Information about Teastalls")),
      ),
      body: showDrivers(),
    );
  }
  ...
  getDriversList() async {
    return await Firestore.instance
        .collection('places')
        .where('Category', isEqualTo: 'Tea Stall')
        .getDocuments();
  }
}
